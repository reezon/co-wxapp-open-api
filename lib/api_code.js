...
exports.queryQuota = function * () {
  ...
  var url = this.wxappPrefix + 'queryquota?access_token=' + componentAccessToken.componentAccessToken
...
exports.speedUpAudit = function * (auditId) {
  var componentAccessToken = yield this.ensureComponentToken()
  var url = this.wxappPrefix + 'speedupaudit?access_token=' + componentAccessToken.componentAccessToken
  var data = {
    auditid: auditId
  }
