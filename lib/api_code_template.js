...
exports.getCodeTemplateDraftList = function * () {
  ...
  var url = this.wxappPrefix + 'gettemplatedraftlist?access_token=' + token.accessToken
...
exports.getCodeTemplateList = function * () {
  var token = yield this.ensureAccessToken()
  var url = this.wxappPrefix + 'gettemplatelist?access_token=' + token.accessToken
...
exports.addCodeTemplate = function * (draftId) {
  var token = yield this.ensureAccessToken()
  var url = this.wxappPrefix + 'addtotemplate?access_token=' + token.accessToken
  var data = {
    draft_id: draftId
  }
...
exports.deleteCodeTemplate = function * (templateId) {
  var token = yield this.ensureAccessToken()
  var url = this.wxappPrefix + 'deletetemplate?access_token=' + token.accessToken
  var data = {
