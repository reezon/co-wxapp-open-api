 ...
 */
exports.addOrder = function * (isHistory, orderList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'importorder?action=add-order&is_history=' + isHistory + '&access_token=' + token.accessToken
  var data = {
 ...
 * @param {array} orderList 单次请求订单数量不可超过10单
 */
exports.updateOrder = function * (isHistory, orderList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'importorder?action=update-order&is_history=' + isHistory + '&access_token=' + token.accessToken
  var data = {
    order_list: orderList
  }
 ...
 */
exports.deleteOrder = function * (userOpenId, orderId) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'deleteorder?aaccess_token=' + token.accessToken
  var data = {
 ...
 */
exports.addShoppingList = function * (userOpenId, skuProductList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'addshoppinglist?aaccess_token=' + token.accessToken
  var data = {
    user_open_id: userOpenId,
 ...
 */
exports.deleteShoppingList = function * (userOpenId, skuProductList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'deleteshoppinglist?aaccess_token=' + token.accessToken
  var data = {
    user_open_id: userOpenId,
    sku_product_list: skuProductList
  }
 ...
 * @param {string} userOpenId 用户微信openid
 */
exports.deleteBizAllShoppingList = function * (userOpenId, skuProductList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'deletebizallshoppinglist?aaccess_token=' + token.accessToken
  var data = {
    user_open_id: userOpenId,
    sku_product_list: skuProductList
  }
 ...
 */
exports.importProduct = function * (productList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'importproduct?aaccess_token=' + token.accessToken
  var data = {
 ...
 */
exports.queryProduct = function * (keyList) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'queryproduct?type=batchquery&aaccess_token=' + token.accessToken
  var data = {
    key_list: keyList
  }
 ...
 */
exports.setBizCanBeSearch = function * (canBeSearch) {
  var token = yield this.ensureAccessToken()
  var url = this.mallPrefix + 'brandmanage?action=set_biz_can_be_search&aaccess_token=' + token.accessToken
  var data = {
