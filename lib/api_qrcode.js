 ...
 * @param {*} lineColor
 */
exports.getWxaQrcode = function * (path, width, autoColor, lineColor, isHyaline) {
 ...
 * @param {*} lineColor
 */
exports.getWxaQrcodeUnlimit = function * (scene, page, width, autoColor, lineColor, isHyaline) {
  var token = yield this.ensureAccessToken()
