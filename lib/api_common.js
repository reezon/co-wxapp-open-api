...
/* !
   ...
   * Examples:
   * ```
   * yield api.createPreAuthCode();
   * ```
   */
API.prototype.createPreAuthCode = function * () {
  var componentAccessToken = yield this.ensureComponentToken()
  var url = this.prefix + 'component/api_create_preauthcode?component_access_token=' + componentAccessToken
  var params = {
    component_appid: this.component_appid
  }
  var options = {
