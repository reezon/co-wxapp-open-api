...
exports.createIcpVerifyTask = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'create_icp_verifytask?access_token=' + token.accessToken
    var data = {
 ...
 */
exports.createIcpVerifyTask = function * (type, certificate_type, icp_order_field, filepath){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'create_icp_verifytask?access_token=' + token.accessToken + '&type=' + type + '&certificate_type=' + certificate_type + '&icp_order_field=' + icp_order_field
  ...
  exports.cancelApplyIcpFiling = function * (){
      var token = yield this.ensureAccessToken()
      var url = this.wxappPrefix + 'cancel_apply_icp_filing?access_token=' + token.accessToken
      var data = {
...
exports.getIcpEntranceInfo = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'get_icp_entrance_info?access_token=' + token.accessToken
    var data = {
...
exports.getOnlineIcpOrder = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'get_online_icp_order?access_token=' + token.accessToken
    var data = {
...
exports.queryIcpServiceContentTypes = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'query_icp_service_content_types?access_token=' + token.accessToken
    var data = {
...
exports.queryIcpCertificateTypes = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'query_icp_certificate_types?access_token=' + token.accessToken
    var data = {
...
exports.queryIcpDistrictCode = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'query_icp_district_code?access_token=' + token.accessToken
    var data = {
...
exports.queryIcpNrlxTypes = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'query_icp_nrlx_types?access_token=' + token.accessToken
    var data = {
...
exports.queryIcpSubjectTypes = function * (){
    var token = yield this.ensureAccessToken()
    var url = this.wxappPrefix + 'query_icp_subject_types?access_token=' + token.accessToken
    var data = {
